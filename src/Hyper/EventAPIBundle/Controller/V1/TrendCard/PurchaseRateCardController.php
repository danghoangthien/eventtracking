...
use Symfony\Component\HttpFoundation\Request,
    ...
    Hyper\EventAPIBundle\Service\TrendCard\PurchaseRateCard\PurchaseRateCardSendToCacheRequest,
...
class PurchaseRateCardController extends APIBaseController
{
    ...
    public function sendToCacheAction(Request $request)
    {
        ...
        try {
            $queueId = $sendToCacheHandler->handle(
                new PurchaseRateCardSendToCacheRequest(
