...
use Symfony\Component\HttpFoundation\Request,
    ...
    Hyper\EventAPIBundle\Service\TrendCard\ModeOfSalesCard\ModeOfSalesCardSendToCacheRequest,
...
class ModeOfSalesCardController extends APIBaseController
{
    ...
    public function sendToCacheAction(Request $request)
    {
        ...
        try {
            $queueId = $sendToCacheHandler->handle(
                new ModeOfSalesCardSendToCacheRequest(
