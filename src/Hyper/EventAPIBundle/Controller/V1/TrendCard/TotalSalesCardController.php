...
use Symfony\Component\HttpFoundation\Request,
    ...
    Hyper\EventAPIBundle\Service\TrendCard\TotalSalesCard\TotalSalesCardSendToCacheRequest,
...
class TotalSalesCardController extends APIBaseController
{
    ...
    public function sendToCacheAction(Request $request)
    {
        ...
        try {
            $queueId = $sendToCacheHandler->handle(
                new TotalSalesCardSendToCacheRequest(
