...
use Symfony\Component\HttpFoundation\Request,
    ...
    Hyper\EventAPIBundle\Service\TrendCard\DormantRateCard\DormantRateCardSendToCacheRequest,
...
class DormantRateCardController extends APIBaseController
{
    ...
    public function sendToCacheAction(Request $request)
    {
        ...
        try {
            $queueId = $sendToCacheHandler->handle(
                new DormantRateCardSendToCacheRequest(
