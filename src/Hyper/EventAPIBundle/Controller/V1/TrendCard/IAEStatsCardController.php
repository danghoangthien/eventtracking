...
use Symfony\Component\HttpFoundation\Request,
    ...
    Hyper\EventAPIBundle\Service\TrendCard\IAEStatsCard\IAEStatsCardSendToCacheRequest,
...
class IAEStatsCardController extends APIBaseController
{
    ...
    public function sendToCacheAction(Request $request)
    {
        ...
        try {
            $queueId = $sendToCacheHandler->handle(
                new IAEStatsCardSendToCacheRequest(
