...
abstract class AInstall extends AAction
{
    /**
     * Repositories
     */
    protected $installActionRepository;
    ...
    public function __construct(
        ...
        InstallActionRepository $installActionRepository
    ) {
        parent::__construct(
            $container,
            $identityRepository,
        ...
        $this->installActionRepository = $installActionRepository;
        
        // TODO - implement monolog,serializer,stopwatch,validator
    }
    
    public function registerInstallEvent() {
        try {
            
            $this->action = $this->storeAction();
            $this->storeInstallAction();
             ...
             * implement error log
             */ 
            throw new \Exception("could not register install action");
        }
    }
    ...
    protected abstract function storeInstallAction();
